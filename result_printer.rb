...
begin
  ...
  def print_viselitsa(errors)
    ...
    puts @status_image[errors].colorize(:yellow)
  end
  ...
  def print_status(game)
    ...
    puts
    puts "Слово: #{get_word_for_print(game.letters, game.good_letters)}".colorize(:blue)
    puts "Ошибки: #{game.bad_letters.join(', ')}".colorize(:red)
